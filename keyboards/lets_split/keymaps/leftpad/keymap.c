...
[_LOWER] = LAYOUT_ortho_4x12( \
  KC_GRV, KC_SLSH,   KC_7,    KC_8,    KC_9, KC_COMM,   KC_HOME, KC_PGDN, KC_PGUP,  KC_END, KC_VOLU, _______,\
 ...
 _______, KC_UNDS,   KC_1,    KC_2,    KC_3,  KC_EQL,   _______, _______, _______, _______, KC_VOLD, _______,\
  KC_ENT, _______,   KC_0,  KC_DOT, _______, _______,   _______, _______, _______, _______, _______, _______\
),
