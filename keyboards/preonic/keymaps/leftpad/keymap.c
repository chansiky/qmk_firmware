...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = {
    ...
    {KC_UNDS,    KC_0,    KC_4,    KC_5,    KC_6, KC_PPLS,   KC_LEFT, KC_DOWN,   KC_UP,KC_RIGHT, _______, _______},
    {_______, KC_MINS,    KC_1,    KC_2,    KC_3,  KC_EQL,   KC_MUTE, KC_VOLD, KC_VOLU, _______, _______, _______},
    {_______, _______, _______, _______, _______, _______,   _______, _______, _______, _______, _______, _______}
  },
  [_RAISE] = {
    ...
    { _______, KC_LCBR, KC_LABK, KC_SCLN, KC_RABK, KC_RCBR, _______, _______, KC_LCBR, KC_RCBR, KC_BSLS, KC_PIPE},
    { _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______}
  },
  [_ADJUST] = {
    {_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______},
    {_______,   KC_F7,   KC_F8,   KC_F9,  KC_F12,  KC_PGUP,  _______,    KC_7, KC_8,    KC_9,  _______, _______},
    {KC_HOME,   KC_F4,   KC_F5,   KC_F6,  KC_F11,  KC_END,   KC_PPLS,    KC_4, KC_5,    KC_6,  KC_MINS, KC_UNDS},
    {_______,   KC_F1,   KC_F2,   KC_F3,  KC_F10,  KC_PGDN,   KC_EQL,    KC_1, KC_2,    KC_3,     KC_0, _______},
    {_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______}
  }
};
