...
*/
  ...
  //|----   +----   +   ----+   ----+   ----+   ----+   ----|    |   ----+   ----+   ----+   ----+   ----+   ----+   ----|
            ,       ,     F5,     F6,     F7,     F8,       ,            ,      4,      5,      6,   MINS,   PPLS,       ,
  //|----   +----   +   ----+   ----+   ----+   ----+   ----|    |   ----+   ----+   ----+   ----+   ----+   ----+   ----|
            ,       ,     F1,     F2,     F3,     F4,       ,            ,      1,      2,      3,   UNDS,    EQL,       ,
  //|----   +----   +   ----+   ----+   ----+   ----+   ----|    |   ----+   ----+   ----+   ----+   ----+   ----+   ----|
            ,       ,       ,       ,       ,       ,       ,            ,      0,   COMM,    DOT,   BSLS,   PIPE,
  //`----   +----   +   ----+   ----+   ----+   ----+   ----'    `   ----+   ----+   ----+   ----+   ----+   ----+   ----'
  ),
 ...
 */
  ...
  //,----   +----   +   ----+   ----+   ----+   ----+   ----.    ,          ----+   ----+   ----+   ----+   ----+   ----+
            ,       ,       ,       ,       ,       ,       ,            ,      ,      ,        ,       ,       ,       ,
  //|----   +----   +   ----+   ----+   ----+   ----+   ----|    |          ----+   ----+   ----+   ----+   ----+   ----|
            ,       ,   TILD,   HOME,     UP,    END,   PGUP,            ,      ,    INS,   LPRN,   RPRN,       ,       ,
  //|----   +----   +   ----+   ----+   ----+   ----+   ----|    |          ----+   ----+   ----+   ----+   ----+   ----|
            ,   CAPS,    GRV,   LEFT,   DOWN,  RIGHT,   PGDN,            ,  BSPC,    DEL,   LBRC,   RBRC,    ENT,       ,
  //|----   +----   +   ----+   ----+   ----+   ----+   ----|    |          ----+   ----+   ----+   ----+   ----+   ----|
            ,       ,   BRID,   BRIU,   VOLD,   VOLU,   MUTE,            ,  BTN1,   BTN2,   LCBR,   RCBR,       ,       ,
  //|----   +----   +   ----+   ----+   ----+   ----+   ----|    |          ----+   ----+   ----+   ----+   ----+   ----|
            ,       ,       ,       ,       ,       ,       ,            ,      ,       ,   LABK,   RABK,       ,
  //`----   +----   +   ----+   ----+   ----+   ----+   ----'    `          ----+   ----+   ----+   ----+   ----+   ----'
  ),
