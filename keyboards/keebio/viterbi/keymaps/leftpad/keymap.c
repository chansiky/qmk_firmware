...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KC_CAPS, KC_LBRC, KC_LEFT, KC_DOWN,KC_RIGHT, KC_RBRC,  _______,  _______, _______, _______, KC_LBRC, KC_RBRC, KC_GRV,  KC_TILD,\
  _______, KC_LCBR, KC_LABK, KC_SCLN, KC_RABK, KC_RCBR,  _______,  _______, _______,TG(_ADJUST),KC_LCBR, KC_RCBR,KC_BSLS, _______,\
  _______, _______, _______, _______, _______, _______,  _______,  _______, _______, _______, _______, _______, _______, _______ \
  ),
  ...
  KC_HOME,   KC_F4,   KC_F5,   KC_F6,  KC_F11,  KC_END,  _______,  _______, KC_PPLS,    KC_4,    KC_5,    KC_6,    KC_0, KC_MINS,\
  _______,   KC_F1,   KC_F2,   KC_F3,  KC_F10,  KC_PGDN, _______,  _______,  KC_EQL,    KC_1,    KC_2,    KC_3, KC_UNDS, _______,\
  _______, _______, _______, _______, _______,  _______, _______,  _______, _______, _______, _______, _______, _______, _______ \
  )
};
