...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT_ortho_5x14(
   ...
   _______, KC_TILD, KC_MINS,   KC_4,    KC_5,    KC_6, KC_PPLS,   KC_LEFT, KC_DOWN,   KC_UP,KC_RIGHT, KC_MUTE, _______, _______,\
   _______, _______, KC_UNDS,   KC_1,    KC_2,    KC_3,  KC_EQL,   _______, _______, _______, _______, KC_VOLD, _______, _______,\
